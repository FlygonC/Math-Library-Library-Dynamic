...
bool operator==(const Matrix3 &me, const Matrix3 &other) {
	for (int i = 0; i <= 2; i++) {
		for (int j = 0; j <= 2; j++) {
...
Matrix3 Matrix3::CreateScaleM3(float X, float Y) {
	Matrix3 Return;
	Return.values[0][0] = X;
	Return.values[0][1] = 0;
	Return.values[0][2] = 0;
...
Matrix3 Matrix3::CreateRotationM3(float radians) {
	Matrix3 Return;
...
Matrix3 Matrix3::CreateTranslationM3(float X, float Y) {
	Matrix3 Return;
	Return.values[0][0] = 1;
	Return.values[0][1] = 0;
	Return.values[0][2] = 0;
