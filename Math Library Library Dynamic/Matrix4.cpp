...
bool operator==(const Matrix4 &me, const Matrix4 &other) {
	for (int i = 0; i <= 3; i++) {
		for (int j = 0; j <= 3; j++) {
...
Matrix4 Matrix4::CreateScaleM4(float X, float Y, float Z) {
	Matrix4 Return;
	Return.values[0][0] = X;
	Return.values[0][1] = 0;
	Return.values[0][2] = 0;
...
Matrix4 Matrix4::CreateXRotationM4(float Xradians) {
	Matrix4 tempX;
	tempX.values[0][0] = 1;
	tempX.values[0][1] = 0;
	tempX.values[0][2] = 0;
...
Matrix4 Matrix4::CreateYRotationM4(float Yradians) {
	Matrix4 tempY;
...
Matrix4 Matrix4::CreateZRotationM4(float Zradians) {
	Matrix4 tempZ;
...
Matrix4 Matrix4::CreateTranslationM4(float X, float Y, float Z) {
	Matrix4 Return;
	Return.values[0][0] = 1;
	Return.values[0][1] = 0;
	Return.values[0][2] = 0;
...
Matrix4 Matrix4::CreateOrthographicProjection(float left, float right, float top, float bottom, float near, float far) {
	Matrix4 Return;
